...
+ (CBToast *)shared
{
    ...
    static CBToast *shared=nil;
    dispatch_once(&onceToken,^{
        shared = [[CBToast allocWithZone:nil] init];
    });
    return shared;
}
...
- (void)setMessage:(NSString *)message
{
    ...
    CGSize size = [CBUtility sizeForString:message font:font width:kBigContentWidth - 2.0 * _margin];
